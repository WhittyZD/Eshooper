...
<head>
    ...
    <meta name="Velazquez Hernandez" content="">
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-8">
						Por: Zoe Dylan Velazquez Hernandez
								...
								<div class="panel-heading">
								 <h4 class="panel-title"><a href="#">Damas</a></h4>
								  <h4 class="panel-title"><a href="#">Caballeros</a></h4>
									...
									<h4 class="panel-title"><a href="#">Electronica</a></h4>
									<h4 class="panel-title"><a href="#">Casas</a></h4>
								...
								<div class="item active">	
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="images/home/6.jpg"alt=""/><h2>$2500</h2>
													<p>Producto Elegante</p>
													<a href="#" class=" btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Agregar al Carrito </a>
												</div>
